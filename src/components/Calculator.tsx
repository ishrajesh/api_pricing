...
export default function ModelCalculator() {
  ...
  // Get all models for feature comparison
  ...
  const calculateCosts = (): ModelCosts[] => {
    ...
    const costs = filteredModels.map((model) => {
      const inputTokens = inputs.useTokens
        ? inputs.inputText
        : inputs.inputText * 1.333;
      const outputTokens = inputs.useTokens
        ? inputs.outputText
        : inputs.outputText * 0.75;
    ...
    const avgCost =
      costs.reduce((acc, curr) => acc + curr.totalCost, 0) / costs.length;
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-4">
                <div>
                  <label className="flex items-center justify-between text-sm font-medium text-gray-700">
                    <span>
                      {inputs.useTokens ? "Input Tokens" : "Input Words"}
                    </span>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setInputs((prev) => ({
                        ...prev,
                        inputText: Number(e.target.value),
                      }))
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setInputs((prev) => ({
                        ...prev,
                        outputText: Number(e.target.value),
                      }))
                    }
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                  />
              ...
              <div className="mt-6 space-y-4">
                ...
                <div>
                  ...
                  {/* Additional batch settings when enabled */}
                </div>
                ...
                <div>
                  ...
                  <select
                    value={projectionSettings.timeframe}
                    onChange={(e) =>
              ...
              <div className="mt-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {(["OpenAI", "Anthropic", "Groq"] as Provider[]).map(
                    (provider) => (
                      <button
                        key={provider}
                        onClick={() => {
          ...
          <div className="lg:col-span-8">
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {calculateCosts().map(
                      ({ model, totalCost, comparisonPercentage }) => (
                        <tr key={model.name}>
            ...
            {/* Analysis Tabs - NEW SECTION */}
            <div className="mt-8">
              <AnalysisTabs
                params={{
                  inputSize: inputs.inputText,
                  outputSize: inputs.outputText,
                  requests: inputs.requests,
                  useTokens: inputs.useTokens,
                  currency: inputs.currency,
                  chartType: visualizationSettings.chartType,
